...
struct NoteStoreTests {
  ...
  func initializesNotesFolder() throws {
    ...
    try fixture.store.initializeNotesFolder()
  ...
  @Test("reads note body")
  func readsNoteBody() throws {
    let fixture = try Fixture()
    defer { fixture.cleanup() }
  ...
  @Test("validates uninitialized and initialized folders")
  func validatesNotesFolder() throws {
    let fixture = try Fixture()
    defer { fixture.cleanup() }

    #expect(fixture.store.validateNotesFolder() == .uninitialized)
    try fixture.store.initializeNotesFolder()
    #expect(fixture.store.validateNotesFolder() == .valid)
  }
...
private struct Fixture {
  ...
  init() throws {
    ...
    store = NoteStore(rootURL: root, fileManager: fileManager)
